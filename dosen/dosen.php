                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            //query untuk mencari data Dosen
                            $sql2 = "SELECT * FROM Dosen WHERE NIP LIKE '%$NIP%' AND Nama LIKE '%$Nama%' AND JenisKelamin LIKE '%$JenisKelamin%'";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td scope="row">
                                        <a href="index.php?op=edit&NIP=<?php echo $NIP ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                        <a href="index.php?op=delete&NIP=<?php echo $NIP ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                            <?php
                            }
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td scope="row"><?php echo $JenisKelamin ?></td>
                                    <td scope="row">
                                        <a href="add.php?op=edit&NIP=<?php echo $NIP ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                        <a href="index.php?op=delete&NIP=<?php echo $NIP ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                        <?php
